...
const iconCategories = [
  {
    name: "Under ₹9",
    icon: <div className="text-sm font-bold text-center text-primary-foreground">Under<br/>₹9</div>,
    href: "/shop?price=9",
    color: 'bg-primary'
  },
  {
    name: "Under ₹19",
    icon: <div className="text-sm font-bold text-center text-primary-foreground">Under<br/>₹19</div>,
    href: "/shop?price=19",
    color: 'bg-foreground'
  },
  {
  ...
  {
    name: "Under ₹49",
    icon: <div className="text-sm font-bold text-center text-primary-foreground">Under<br/>₹49</div>,
    href: "/shop?price=49",
    color: 'bg-foreground'
  },
  {
    name: "Under ₹199",
    icon: <div className="text-sm font-bold text-center text-primary-foreground">Under<br/>₹199</div>,
    href: "/shop?price=199",
    color: 'bg-foreground'
  },
];
  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 md:gap-8 justify-items-center">
