        ...
        {showGeneral && (
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                <Label htmlFor="upload_provider">Customer Upload Storage</Label>
                <div className="grid grid-cols-2 gap-2">
                  <label className="flex items-center gap-2 border rounded-md p-3 cursor-pointer">
                    <input
                      ...
                      value="supabase"
                      defaultChecked={(settings.upload_provider || 'supabase') === 'supabase'}
                    />
                  ...
                  <label className="flex items-center gap-2 border rounded-md p-3 cursor-pointer">
                    <input
                      ...
                      name="upload_provider"
                      value="r2"
                      defaultChecked={settings.upload_provider === 'r2'}
                    />
                    <span>Cloudflare R2</span>
                  </label>
                </div>
                <p className="text-xs text-muted-foreground">
                  Select where customer images are stored. Configure credentials in environment.
                </p>
              </div>
              <div className="grid gap-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4 space-y-4">
                <div className="flex items-center space-x-2">
                  <Switch
                    id="whatsapp_only_checkout_enabled"
                    name="whatsapp_only_checkout_enabled"
                    defaultChecked={settings.whatsapp_only_checkout_enabled}
                  />
                  <Label htmlFor="whatsapp_only_checkout_enabled">Enable WhatsApp-only checkout</Label>
                </div>
                <p className="text-xs text-muted-foreground">
                  When enabled, customers will confirm orders via WhatsApp instead of paying advance online.
                </p>
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    defaultValue={settings.whatsapp_business_number || ''}
                    placeholder="e.g. 9162XXXXXXX"
                  />
                  <p className="text-xs text-muted-foreground">
                    Used for pre-filled WhatsApp messages (include country code, no + sign).
                  </p>
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="whatsapp_message_template">Default WhatsApp Message Template</Label>
                  <Textarea
                    id="whatsapp_message_template"
                    name="whatsapp_message_template"
                    defaultValue={settings.whatsapp_message_template || 'Hi, I want to place an order.'}
                    rows={3}
                  />
                  <p className="text-xs text-muted-foreground">
                    This text will be pre-filled when customers open WhatsApp-only checkout.
                  </p>
                </div>
              </div>
            </CardContent>
